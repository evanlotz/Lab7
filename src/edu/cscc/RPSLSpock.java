...
public class RPSLSpock {
    ...
    /**
     * Checks if the option picked is valid
     * @param pick  the user choice
     * @return      returns a standardised string based on what the user picked
     */
     ...
     * @return  Returns the computer's pick as a string: rock paper scissors lizard or spock
     */
    ...
    /**
     * Checks if the computer or the human won
     * @param c_pick The computer's pick
     * @param h_pick The human's pick
     * @return true if the computer won or false if the human won
     */
